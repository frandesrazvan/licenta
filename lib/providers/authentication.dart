...
class Authentication with ChangeNotifier {
  ...
  Future<void> _authenticate(
      String email, String password, String urlSwitcher) async {
    final url =
        'https://identitytoolkit.googleapis.com/v1/accounts:$urlSwitcher?key=AIzaSyDf5rGSwg7Wo8fyAQ2K0XsAjjRABAfpM4g';
